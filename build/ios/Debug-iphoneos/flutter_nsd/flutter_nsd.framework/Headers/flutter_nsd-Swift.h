...
#ifndef FLUTTER_NSD_SWIFT_H
#define FLUTTER_NSD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_nsd",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11flutter_nsd21SwiftFlutterNsdPlugin")
@interface SwiftFlutterNsdPlugin : NSObject <FlutterPlugin, NSNetServiceBrowserDelegate, NSNetServiceDelegate>
